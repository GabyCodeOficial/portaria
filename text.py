...
# Atualiza o horário de saída e o tempo de permanência no banco de dados
try:
self.cursor.execute("ALTER TABLE cadastros ADD COLUMN horario_saida TEXT")
self.cursor.execute("ALTER TABLE cadastros ADD COLUMN tempo_permanencia TEXT")
except sqlite3.OperationalError:
# As colunas já existem
pass
